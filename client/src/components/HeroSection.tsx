      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h1 className="font-space font-bold text-4xl md:text-6xl leading-tight text-white mb-6">
            Tu negocio, <span className="text-primary">en estado de flow.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a 
              href="#contact" 
              className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-dark-900 font-medium py-3 px-8 rounded-lg transition-all shadow-lg shadow-primary/20 hover:shadow-primary/30 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-900"
            >
              Agendar una llamada
            </a>
            <a 
