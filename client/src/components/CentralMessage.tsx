      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="font-space font-bold text-3xl md:text-5xl mb-6 text-white">
            Cada solución es <span className="text-primary font-script">personalizada.</span>
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Diseñamos sistemas <span className="font-script text-primary">inteligentes</span> a la medida, para que tú puedas enfocarte en lo que importa.
          </p>
        </div>
      </div>
    </section>
